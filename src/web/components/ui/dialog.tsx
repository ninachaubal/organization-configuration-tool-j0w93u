...
// Overlay component that covers the background when dialog is open
...
// Content component that contains dialog content
...
// Footer section for dialog, typically containing action buttons
const DialogFooter = ({
  className,
  ...props
}: React.HTMLAttributes<HTMLDivElement>) => (
